 ...
 * ビューへの新規タブ追加のE2Eテスト
 *
 * Task 10.1: 現在ビューへの新規タブ追加機能
 * Task 10.2: ビューへの新規タブ追加のE2Eテスト追加
 * Requirements: 10.1, 10.2, 10.3, 10.4, 10.5, 10.6
 *
 * テスト対象:
 * 1. ビューを開いている状態で新しいタブをそのビューに追加 (Requirement 10.1)
 * 2. 新規タブ追加後もViewSwitcherが現在のビューを維持 (Requirement 10.2)
 * 3. デフォルトビュー以外のビューでも新規タブが現在ビューに属する (Requirement 10.3)
 */
...
test.describe('ビューへの新規タブ追加', () => {
  test.describe('Requirement 10.1: ビューを開いている状態で新しいタブをそのビューに追加', () => {
  ...
  test.describe('Requirement 10.2: 新規タブ追加後もViewSwitcherが現在のビューを維持', () => {
  ...
  test.describe('Requirement 10.3: デフォルトビュー以外のビューでも新規タブが現在ビューに属する', () => {
  ...
  test.describe('Requirement 10.4, 10.5, 10.6: E2Eテスト検証', () => {
